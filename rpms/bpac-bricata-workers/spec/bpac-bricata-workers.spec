...
Name:           bpac-bricata-workers
Version:        %{?bpacver}%{!?bpacver:1.0}%{?gitver}
Release:        1%{?dist}
Summary:        Service and startup scripts for bricata(snorby)
Group:          bricata
...
# Bricata workers must be running under apache user, otherwise they cannot be restarted.
Requires:       httpd
...
Requires:   ruby193-rubygem-dotenv
Requires:   ruby193-rubygem-dotenv-rails
...
Requires:   ruby193-rubygem-ezprint
...
%attr(755,root,root) /usr/bin/check-worker-running

/etc/sysconfig/bpac-bricata-workers
/usr/lib/systemd/system/bpac-bricata-workers.service
/usr/lib/tmpfiles.d/bpac-bricata-workers.conf
