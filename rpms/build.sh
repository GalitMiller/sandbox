...
main() {
  ...
  make_tar_archives "$BIN_DIR" "$ARCHIVES_TMP_DIR" || return 1
  make_tar_archive_of_dir "$BIN_DIR/../backend" "$ARCHIVES_TMP_DIR" "bpac-backend" || return 1
  make_tar_archive_of_dir "$BIN_DIR/../webapp" "$ARCHIVES_TMP_DIR" "bpac-webapp" || return 1
