  ...
  Limp.prototype = {
    ...
    error: function(xhr, textStatus, errorThrown) {
      ...
      try {
        ...
        var html = "<div class='bricata-cloud-box'><div class='bricata-cloud-box-title'><div class='icon' />Loading Error</div><div class='bricata-cloud-box-content'><span>Error: Not Found</span></div>" +
        "<div class='bricata-cloud-box-footer'><div class='form-actions'><button class='form-button default' onClick='$.limpClose()'>Ok</button></div></div>" +
        "</div>";
