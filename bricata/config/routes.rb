Bricata::Application.routes.draw do
  ...
  resources :policies, :path => '/static/#/policies' do

  end

  resources :ext_signatures, :path => '/static/#/signatures' do
  
  end

  resources :ext_categories, :path => '/static/#/signatures/categories' do

  end

  resources :ext_classtypes, :path => '/static/#/signatures/classtypes' do

  end

  resources :ext_severities, :path => '/static/#/signatures/severities' do

  end

  resources :ext_references, :path => '/static/#/signatures/references' do
