angular.module("bricata.uicore.validation")
    .directive("policySelectValidation", ["$i18next", "$rootScope", "ValidationService",
            ...
            link: function(scope, element, attr) {
                ...
                scope.performValidation = function() {
                    ...
                    if (emptyError.length > 0) {
                        ...
                        scope.$emit('policies.select.validation.processed',
                            {isValid: false});
               ...
               scope.searchForEmpty = function() {
                   ...
                   for (var i = 0; i < scope.rowsModel.length; i++) {
                       ...
                       if (!angular.isDefined(entity.policy.id) || entity.policy.id === '' ||
                           !angular.isDefined(entity.action.value) || entity.action.value === '') {
               ...
               scope.searchForDuplicates = function() {
                   ...
                   for (var i = 0; i < scope.rowsModel.length; i++) {
                       ...
                       for (k = 0; k < scope.rowsModel.length; k++) {
                           ...
                           if (i !== k && entity.policy.name === potentialDuplicate.policy.name) {
                               errorMsg = "applyPolicyModal.errorDuplicatedPolicies";
